...
export function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'glass fixed left-0 top-0 h-screen w-64 z-40 border-r transition-transform duration-300 md:relative md:translate-x-0',
          ...
          <div className="p-6 border-b border-white/10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-bold text-gradient-blue-cyan">
                  OCULIZ
                </span>
              </div>
              <button
